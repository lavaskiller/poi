...
RULE_VERSION = "unique-direct-ocr-or-raw-top5-choice+candidate-name-free-specialty-yes-v4-exploratory"
CACHE_SCHEMA = 1
...
def main() -> int:
    ...
    parser.add_argument("--verification-cache", default=str(ROOT / "poi-data/generated/fastvlm_bloggo_ocr_fastvlm_semantic_v4_cache.jsonl")); parser.add_argument("--results-tsv", default=str(ROOT / "poi-data/fastvlm_bloggo_ocr_fastvlm_semantic_v4_results.tsv"))
    parser.add_argument("--run-name", default="selector-ocr-vlm-specialty")
